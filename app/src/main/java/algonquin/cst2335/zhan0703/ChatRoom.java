...
public class ChatRoom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().add(R.id.fragmentRoom, chatFragment).addToBackStack(null).commit();
    }
    ...
    public void userClickedMessage(MessageListFragment.ChatMessage chatMessage, int position) {
        ...
        if(isTablet){
            getSupportFragmentManager().beginTransaction().replace(R.id.detailsRoom, mdFragment).addToBackStack(null).commit();
        }else{
            //phone load second fragment over the top of the list
            getSupportFragmentManager().beginTransaction().add(R.id.fragmentRoom, mdFragment).addToBackStack(null).commit();
        }
    }
